...
<!-- setup selector -->
<?php
$edit = mysqli_query($con,"SELECT * FROM tb_berita WHERE id='$_GET[id]' ");
foreach ($edit as $d)?>
<div class="page-inner">
          ...
          <div class="row">
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Edit Berita</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=berita&act=proses" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
								...
								<input name="sub" type="text" class="form-control" value="<?=$d['submenu'] ?>">
							</div>
              <div class="form-group">
								<label>Tanggal</label>
