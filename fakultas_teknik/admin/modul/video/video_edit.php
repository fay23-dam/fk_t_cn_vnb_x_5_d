...
<!-- setup selector -->
<?php
$edit = mysqli_query($con,"SELECT * FROM tb_video WHERE id='$_GET[id]' ");
foreach ($edit as $d)?>
<div class="page-inner">
          ...
          <div class="row">
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Edit Video</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=video&act=proses" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                            ...
                            <div class="form-group">
								<label>Video</label>
								<input name="file_v" type="file" class="form-control" value="<?=$d['video'] ?>">
